...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        var pxfh_hmi;
        (function (pxfh_hmi) {
            function CalcPowerLineData2(powerSchedule) {
                var selectedPowerSchedule = powerSchedule;
            ...
            pxfh_hmi.CalcPowerLineData2 = CalcPowerLineData2;
        })(pxfh_hmi = Functions.pxfh_hmi || (Functions.pxfh_hmi = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx('CalcPowerLineData2', 'TcHmi.Functions.pxfh_hmi', TcHmi.Functions.pxfh_hmi.CalcPowerLineData2);
